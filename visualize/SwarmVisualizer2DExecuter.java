...
public class SwarmVisualizer2DExecuter extends JPanel implements ActionListener{
    ...
    SwarmSimulator2D simulator;
    
    ArrayList<GridCell2D> currentGridCells;
    ArrayList<GridCell2D> previousGridCells;
    
    public SwarmVisualizer2DExecuter(int xDim, int yDim,  SwarmSimulator2D argSimulator, 
