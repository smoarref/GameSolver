...
public class CompositionalCoordinationStrategy extends CoordinationGameStructure{
	...
	public CompositionalCoordinationStrategy(BDD argBdd) {
		super(argBdd);
	}
	
	public  CompositionalCoordinationStrategy(BDD argBDD, CompositionalCoordinationGameStructure argCoordinationGameStructure, Variable[] argCounterVariables, ArrayList<Integer> argStrategy, int argCounterUpdateFormula){
		super(argBDD);
